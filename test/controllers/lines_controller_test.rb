...
class LinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post lines_url, params: { line: { cart_id: @line.cart_id, product_id: @line.product_id } }
    end
  ...
  test "should update line" do
    patch line_url(@line), params: { line: { cart_id: @line.cart_id, product_id: @line.product_id } }
